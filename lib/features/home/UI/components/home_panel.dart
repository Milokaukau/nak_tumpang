...
class HomePanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shouldShowMatching = viewModel.showMatchingUI;
          ...
          child: viewModel.isScreenLoading
              ...
              : ListView(
                  ...
                  children: [
                    ...
                    // --- Back button ---
                    if (hasSubscriptions && shouldShowMatching)
                      Padding(
                    ...
                    // --- VIEW MODE A: ACTIVE SUBSCRIPTIONS ---
                    if (hasSubscriptions && !shouldShowMatching)
                      ..._buildActiveSubscriptions(viewModel)
                    // --- VIEW MODE B: DRIVER MATCHING UI ---
                    else
                      ..._buildMatchingUI(viewModel),
                  ],
                ),
        );
      },
  ...
  List<Widget> _buildActiveSubscriptions(HomeViewModel viewModel) {
    return [
      const Text(
        ...
        return Column(
          children: [
            ActiveSubscriptionCard(
              driverName: sub['driver_name'],
              driverPhone: sub['driver_phone'],
              driverImageUrl: sub['driver_image_url'],
  ...
  List<Widget> _buildMatchingUI(HomeViewModel viewModel) {
    return [
